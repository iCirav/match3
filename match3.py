...
class Game (Scene):
	...
	def update(self):
		...
		if self.bTimer == 1:
			sec_left = 60
			self.time_label.text = 'Unlimited Mode'
	...
	def show_pause_menu(self):
		self.paused = True
		self.menu = MenuScene('Paused', 'Highscore: %i' % self.highscore, ['Continue', 'New Game', 'Unlimited Mode'])
		self.present_modal_scene(self.menu)
	
	def show_start_menu(self):
		self.paused = True
		self.menu = MenuScene('Match3', 'Highscore: %i' % self.highscore, ['New Game', 'Unlimited Mode'])
		self.present_modal_scene(self.menu)
		
	def show_game_over_menu(self):
		self.paused = True
		self.menu = MenuScene('Time Up!', 'Score: %i' % (self.score), ['New Game', 'Unlimited Mode'])
		self.present_modal_scene(self.menu)
	...
	def menu_button_selected(self, title):
		...
		elif title in ('Continue', 'New Game', 'Unlimited Mode'):
